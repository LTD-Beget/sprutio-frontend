...
Ext.define('FM.view.forms.SettingsForm', {
  ...
  bodyPadding: 0,
  requires: ['Ext.ux.form.SearchField', 'Ext.form.field.Checkbox', 'Ext.form.Label', 'Ext.tab.Panel'],
  defaults: {
    margin: 0
  },
