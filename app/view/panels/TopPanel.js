...
(function() {
  Ext.define('FM.view.panels.TopPanel', {
    ...
    updateButtonsState: function(panel, files) {
      var analyze_size_button, create_archive_button, download_archive_button, home_button, mkdir_button, refresh_button, remote_button, remote_webdav_button, search_files_button, search_text_button, terminal_button, upload_button;
      ...
      terminal_button = Ext.ComponentQuery.query("button[name=" + FM.Actions.Terminal.getIconCls() + "]", this.items.get(0))[0];
    ...
    updateMenuState: function(panel, files) {
      var analyze_size_button, chmod_button, copy_button, create_archive_button, create_copy_button, download_basic_button, download_button, download_bzip_button, download_gzip_button, download_tar_button, download_zip_button, edit_button, home_button, ipblock_button, mkdir_button, move_button, new_button, new_file_button, operations_button, refresh_button, remote_button, remote_webdav_button, remove_button, rename_button, search_files_button, search_menu, search_text_button, terminal_button, toolbar, upload_button, view_button;
