...
Ext.define('FM.view.toolbars.EditorTopToolbar', {
  ...
  initComponent: function() {
      ...
      menu: [
        {
          ...
          text: t("Save in"),
          menu: {
            items: Ext.Array.map(FM.Editor.getEncodings(), (function(_this) {
              return function(enc) {
                return {
                  text: enc,
                  handler: function(item) {
                    return _this.ownerCt.save(item.text);
                  }
                };
              };
            })(this))
    ...
    this.items.push({
      ...
      menu: {
        items: Ext.Array.map(FM.Editor.getModes(), (function(_this) {
    ...
    this.items.push({
      ...
      handler: (function(_this) {
        return function() {
          _this.ownerCt.editor.execCommand('replace');
          return setTimeout(function() {
            if (_this.ownerCt.editor.searchBox != null) {
              $('input.ace_search_field', _this.ownerCt.editor.searchBox.searchBox).attr('placeholder', t("Search for"));
              $('[action=findAll]', _this.ownerCt.editor.searchBox.searchBox).text(t("All"));
