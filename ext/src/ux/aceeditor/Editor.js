...
Ext.define('Ext.ux.aceeditor.Editor', {
    ...
    initEditor: function()
    {
        ...
        me.editor.setOptions({
            enableBasicAutocompletion: me.enableBasicAutocompletion,
            enableLiveAutocompletion: me.enableLiveAutocompletion,
            enableSnippets: me.enableSnippets,
            enableEmmet: me.enableEmmet
        });
