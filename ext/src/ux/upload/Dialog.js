...
Ext.define('Ext.ux.upload.Dialog', {
    ...
    config : {
        ...
        uploadMessageText : 'Upload progress {0}% ({1} of {2} files)',
    ...
    onInitUpload : function() {
        ...
        FM.helpers.CheckOverwrite(FM.Active, queue.items, function(overwrite) {
            self.uploadManager.extraParams.overwrite = overwrite;
